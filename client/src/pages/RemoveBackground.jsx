...
<button disabled={loading} className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 mt-6 rounded-lg text-sm cursor-pointer'>
  {loading ? <ClipLoader color='white' size={20} /> : <Eraser className='w-5' /> }
  Remove Background
</button>
    </form>
